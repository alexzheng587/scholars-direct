export const initialQuestionList = [
    {
...
export const questionConstants = {
    FETCH_SUCCESS: 'FETCH_QUESTION_SUCCESS',
    FETCH_ERROR: 'FETCH_QUESTION_ERROR',
    FETCH_REQUEST: 'FETCH_QUESTION_REQUESTED',
    ADD_SUCCESS: 'ADD_QUESTION_SUCCESS',
    ADD_ERROR: 'ADD_QUESTION_ERROR',
    ADD_REQUEST: 'ADD_QUESTION_REQUESTED',
    DELETE_SUCCESS: 'DELETE_QUESTION_SUCCESS',
    DELETE_ERROR: 'DELETE_QUESTION_ERROR',
    DELETE_REQUEST: 'DELETE_QUESTION_REQUESTED'
};